...
draw.line((25, 35, 10, 10), fill="black", width=3)
draw.line((25, 35, 5, 25), fill="black", width=3)  # Left antler bottom
draw.line((75, 35, 90, 10), fill="black", width=3)  # Right antler top
draw.line((75, 35, 95, 25), fill="black", width=3)  # Right antler bottom
